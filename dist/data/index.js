...
exports.products = exports.salt = exports.tea = exports.beverages = exports.seeds = exports.sweeteners = exports.rice = exports.pulses = exports.millets = void 0;
exports.millets = [
    {
      ...
      `,
        cutoffPrice: [300, 200],
        category: "67f0f6adfd32175ffa5a6f60",
        images: ["/product/millets/finger-millet-1.jpeg"],
        variants: [{
                display: "900g",
                value: 0.9,
            }, {
...
exports.pulses = [
    ...
    `,
        price: [259, 160],
        cutoffPrice: [300, 210],
        category: "67f0f9326f1a4a49b3856678",
        images: ["/product/pulses/pahadi-white-soyabean.jpeg"],
        variants: [{
                display: "900g",
                value: 0.9,
            }, {
...
`,
        ...
        cutoffPrice: [350, 230],
        category: "67f0f9326f1a4a49b3856678",
        images: ["/product/pulses/naurangi-dal.jpeg"],
        variants: [{
                display: "900g",
                value: 0.9,
            }, {
...
`,
        ...
        cutoffPrice: [340, 210],
        category: "67f0f9326f1a4a49b3856678",
        images: ["/product/pulses/rali-mili-dal.jpeg"],
        variants: [{
                display: "900g",
                value: 0.9,
            }, {
        ...
        storage: "For best use store it in a cool and dry place in air-tight container.",
        dimensions: [{
                length: 11,
                breadth: 7,
                height: 1.5,
...
`,
        price: [324, 182],
        cutoffPrice: [380, 210],
        category: "67f100e69310b2f3ae8ee9cf",
        images: ["/product/rice/red-rice.png"],
        variants: [{
                display: "900g",
                value: 0.9,
            }, {
...
`,
        ...
        cutoffPrice: [510, 340],
        category: "67f100e69310b2f3ae8ee9cf",
        images: ["/product/rice/black-rice.png"],
        variants: [{
                display: "900g",
                value: 0.9,
            }, {
...
`,
        ...
        cutoffPrice: [380, 700],
        rating: 4.8,
        category: "67f101e0066fdaffb35ec056",
        images: ["/product/sweeteners/jaggery-powder.jpeg"],
        variants: [{
                display: "1kg",
                value: 1.0,
            }, {
...
`,
        ...
        cutoffPrice: [320],
        category: "67f101e0066fdaffb35ec056",
        images: ["/product/sweeteners/raw-sugar.jpeg"],
        variants: [{
                display: "1kg",
                value: 1.0,
            }],
        ...
        storage: "Once opened, store it in a clean, dry, and airtight container, away from direct sunlight.",
        dimensions: [{
                length: 12,
                breadth: 7,
                height: 2.5,
...
`,
        price: [246],
        cutoffPrice: [320],
        category: "67f1044689afe52f18f0c3bf",
        images: ["/product/IMG_6264.jpg"],
        variants: [{
                display: "250g",
                value: 0.25,
            }],
    ...
    {
        name: "Hemp Seeds",
        hindiName: "Bhang ke Beej",
        description: `
      Our Hemp Seeds are a powerhouse of nutrition, sourced from the pristine Himalayan region. These tiny seeds are rich in protein, essential fatty acids, and fiber. With a mild, nutty flavor, they can be consumed raw, roasted, or blended into smoothies, sprinkled on salads, or added to your favorite dishes. Ideal for those seeking a plant-based protein source and a boost in daily nutrition.
    `,
        price: [246],
        cutoffPrice: [320],
        category: "67f1044689afe52f18f0c3bf",
        images: ["/product/hemp-seeds.jpg"],
        variants: [{
                display: "250g",
                value: 0.25,
            }],
        ...
        ingredients: ["Raw hemp seeds"],
        storage: "Store in a cool, dry place away from direct sunlight. Keep in an airtight container.",
        dimensions: [{
                length: 8,
                breadth: 5,
                height: 1,
...
`,
        price: [293],
        cutoffPrice: [340],
        category: "67f10be23bb3cafad712c3cf",
        images: ["/product/beverages/buransh-squash.jpeg"],
        variants: [{
                display: "500ml",
                value: 0.5,
            }],
        ...
        storage: "Store in a cool and dry place, consume within 1 month after opening.",
        stock: 1000,
        dimensions: [{
                length: 8,
                breadth: 2.5,
...
`,
        ...
        cutoffPrice: [410],
        category: "67f10be23bb3cafad712c3cf",
        images: ["/product/beverages/malta-squash.jpeg"],
        variants: [{
                display: "500ml",
                value: 0.5,
            }],
        ...
        storage: "Store it in a cool and dry place, away from direct sunlight. Once opened, consume within 1 month.",
        stock: 1000,
        dimensions: [{
                length: 8,
                breadth: 2.5,
...
`,
        price: [449],
        cutoffPrice: [540],
        category: "67f10ca8c6053ee32f8aa885",
...
`,
        price: [207],
        cutoffPrice: [250],
        category: "67f10d5ad23d0153424278c7",
        images: ["/product/IMG_6260.jpg"],
        variants: [{
                display: "250g",
                value: 0.25,
            }],
        ...
        storage: "For best use, store it in a cool and dry place, away from direct sunlight.",
        dimensions: [{
                length: 5,
                breadth: 2,
                height: 2,
